Graph {
	...
	// for sake of handling the dict must be: al fine di gestire l'ordine deve essere
	...
	var <>annotationSize; // the number of annotation parameters you need to store in the vertex opts
