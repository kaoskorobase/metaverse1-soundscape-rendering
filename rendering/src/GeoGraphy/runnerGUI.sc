...
// Ricorda impostazioni monitor, da standardizzare per 1280x800 su win
...
RunnerGUI {
	...
	*new {Ê arg runner, yStep = 1040, x = 50, y = 10, controlNum ; //modificato da M prima x= 1040 y= 900
	...
	connectActant { arg actantID ;
		...
		if (gui.notNil, {
			...
			gui[3].string_("                             ") ;	//aumentati gli spazi da M per vedere meglio vertice in play
			gui[4]
